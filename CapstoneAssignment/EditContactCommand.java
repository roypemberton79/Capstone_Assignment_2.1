...
public class EditContactCommand extends Command {
    ...
    public EditContactCommand(ContactList conatact_list, Contact old_contact, Contact new_contact, Context context) {
    ...
    public void execute() {
        ...
        setIsExecuted(contact_list.saveContact(context));
    }
}
